...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // 自動返信メールの送信者と受信者
        $mail->setFrom('info@minorica-agri.com', '株式会社MINORICA'); // 送信元を会社のメールアドレスに設定
        $mail->addAddress($email, $name); // お問い合わせされた方のメールアドレスを受信者に設定
        $mail->addReplyTo('info@minorica-agri.com', '株式会社MINORICA'); // 返信先を会社のアドレスに設定
        ...
        $auto_reply_body .= "メール: info@minorica-agri.com\n"; // 必要に応じて正しいアドレスに
